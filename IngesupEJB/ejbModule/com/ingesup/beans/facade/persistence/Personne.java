...
/** @pdOid e15010f7-9c0c-4114-bca0-cf668499bd3a */
public class Personne {
   /** @pdOid c3e329c9-3a4a-4ce9-9bcf-9d4e3e61be4f */
   public int idPersonne;
   /** @pdOid 396d1d89-d6c1-4738-8faf-4e07a8756e6d */
   public java.lang.String nomPers;
   /** @pdOid c058c340-85dc-4dbf-b2b5-a7b4a11a641e */
   public java.lang.String prenomPers;
   /** @pdOid cc77b009-53aa-4a34-9f3b-a7f962e00a6f */
   public java.lang.String emailPers;
   
   /** @pdRoleInfo migr=no name=Professeur assc=herite coll=java.util.Collection impl=java.util.HashSet mult=0..* type=Composition */
   public java.util.Collection<Professeur> professeur;
   /** @pdRoleInfo migr=no name=Etudiant assc=herite coll=java.util.Collection impl=java.util.HashSet mult=0..* type=Composition */
   public java.util.Collection<Etudiant> etudiant;
   /** @pdRoleInfo migr=no name=ServicePedagogique assc=herite coll=java.util.Collection impl=java.util.HashSet mult=0..* type=Composition */
   public java.util.Collection<ServicePedagogique> servicePedagogique;
   /** @pdRoleInfo migr=no name=ChargePlacement assc=herite coll=java.util.Collection impl=java.util.HashSet mult=0..* type=Composition */
   public java.util.Collection<ChargePlacement> chargePlacement;
   
   
   /** @pdGenerated default getter */
   public java.util.Collection<Professeur> getProfesseur() {
      if (professeur == null)
   ...
   /** @pdGenerated default setter
     * @param newProfesseur */
   public void setProfesseur(java.util.Collection<Professeur> newProfesseur) {
      removeAllProfesseur();
   ...
   /** @pdGenerated default getter */
   public java.util.Collection<ServicePedagogique> getServicePedagogique() {
      if (servicePedagogique == null)
         servicePedagogique = new java.util.HashSet<ServicePedagogique>();
   ...
   public void setServicePedagogique(java.util.Collection<ServicePedagogique> newServicePedagogique) {
   ...
   public void addServicePedagogique(ServicePedagogique newServicePedagogique) {
      ...
      if (this.servicePedagogique == null)
         this.servicePedagogique = new java.util.HashSet<ServicePedagogique>();
   ...
   /** @pdGenerated default getter */
   public java.util.Collection<ChargePlacement> getChargePlacement() {
      if (chargePlacement == null)
         chargePlacement = new java.util.HashSet<ChargePlacement>();
   ...
   public void setChargePlacement(java.util.Collection<ChargePlacement> newChargePlacement) {
   ...
   public void addChargePlacement(ChargePlacement newChargePlacement) {
      ...
      if (this.chargePlacement == null)
         this.chargePlacement = new java.util.HashSet<ChargePlacement>();
